...
PUBLICATION_MAX_RECORD_BYTES: int = int(os.getenv("PUBLICATION_MAX_RECORD_BYTES", "2000000"))
PUBLICATION_MAX_EXTRACTED_TEXT_CHARS: int = int(os.getenv("PUBLICATION_MAX_EXTRACTED_TEXT_CHARS", "1000000"))
